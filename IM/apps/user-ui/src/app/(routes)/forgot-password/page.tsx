    ...
    const resetPasswordMutation = useMutation({
        mutationFn: async({ password } : {password: string}) => {
            ...
            const response = await axios.post(
                `${process.env.NEXT_PUBLIC_SERVER_URI}/api/reset-forgot-password-user`,
  ...
  return (
    <div className="w-full py-10 min-h-[85vh] bg-[#f1f1f1]">
        ...
        <div className="w-full flex justify-center">
            <div className="md:w-[480px] p-8 bg-white rounded-lg">
                {step == "email" && (
                    <>
                    <h3 className="text-3xl font-semibold text-center mb-2">
          Login To Infinite_Market
        </h3>
        <p className="text-center text-gray-500 mb-4">
            ...
            <Link href={"/login"} className="text-blue-500">
                ...
                <form onSubmit={handleSubmit(onSubmitEmail)}>
                    ...
                    <input type="email"
                    placeholder="infinitemarket30@gmail.com"
                    ...
                    <button type="submit" disabled={requestOtpMutation.isPending} className="w-full text-lg cursor-pointer mt-4 bg-black text-white py-2 rounded-lg">
